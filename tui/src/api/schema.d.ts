...
export interface paths {
    ...
    "/v1/session/{id}/task/{task_id}/background": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         */
        post: operations["background_task"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        /**
         * @description Result of moving a running foreground subagent to the durable background
        ...
        /**
         * @description Durable lifecycle of a compaction request. A failed marker remains an
         *     audit record but is excluded from both model projection and the timeline.
         * @enum {string}
         */
        CompactionAttemptState: "pending" | "committed" | "failed";
        ...
        EventDto: {
            ...
            entries: components["schemas"]["RosterEntryDto"][];
            /** @enum {string} */
        ...
        PartDto: {
            ...
            state: components["schemas"]["CompactionAttemptState"];
            ...
            reminder_kind: components["schemas"]["ReminderKind"];
            stable_key: string;
        };
        /**
        ...
        /**
         * @description `POST /v1/session/:id/question/answer` body. `question_id` matches
        ...
        /**
         * @description Provenance-bearing kind of a runtime reminder. A reminder is
         ...
         * @enum {string}
         */
        ReminderKind: "execution_constraint" | "task_state" | "workspace_delta" | "background_task_settled" | "compaction_recovery" | "runtime_limit" | "exceptional_outcome";
        /**
...
export interface operations {
    ...
    background_task: {
        ...
        requestBody?: never;
        responses: {
            /** @description Task is or was backgrounded */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["BackgroundTaskAckDto"];
                };
            };
            ...
            /** @description Task already settled */
            409: {
                headers: {
                    [name: string]: unknown;
                };
