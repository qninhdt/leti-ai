...
| 12 | Real-LLM acceptance | ✅ | M18 scrubber + 8 live tests (7 suites) PASS against real OpenRouter — incl. 4 multi-turn scenarios (cross-file refactor, debug-fix-verify, scaffold-discovery, compaction-continuity) |
