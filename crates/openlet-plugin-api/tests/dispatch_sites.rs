...
//! suites in `openlet-core` / `openlet-adapters`; this file pins the
...
use openlet_plugin_api::dispatch::{
    DispatchOutcome, FaultKind, HookEntry, HookFuture, dispatch, dispatch_event,
};
use openlet_plugin_api::hooks::{HookKind, HookResult, Priority, io::OnEventCtx};
