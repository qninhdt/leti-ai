...
/// `str::floor_char_boundary`. Consolidates byte-identical
/// re-implementations that previously lived in several adapter modules,
/// including `openai/transport.rs`, `pyexec/executor.rs`,
/// `emushell/eval.rs`, and
