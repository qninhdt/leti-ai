...
use leti_plugin_api::manifest::PluginManifest;
...
pub fn all_plugins(
    ...
    let mut core_tools =
        leti_plugin_core_tools::CoreToolsPlugin::new(shell, memory, task_registry, spawner);
    ...
    vec![
        Arc::new(leti_plugin_core_agents::CoreAgentsPlugin::new()),
        Arc::new(core_tools),
    ]
}
