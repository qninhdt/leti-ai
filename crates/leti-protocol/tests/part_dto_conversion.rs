...
fn text_part_converts_to_domain() {
    ...
    match part {
        leti_core::types::part::Part::Text { id, text } => {
...
fn reasoning_part_converts_to_domain() {
    ...
    match part {
        leti_core::types::part::Part::Reasoning { id: pid, text } => {
...
fn runtime_reminder_returns_none() {
    ...
    let dto = PartDto::RuntimeReminder {
        id: Uuid::nil(),
        reminder_kind: leti_core::types::part::ReminderKind::ExecutionConstraint,
...
fn runtime_reminder_survives_dto_roundtrip_without_becoming_text() {
    ...
    let domain = leti_core::types::part::Part::RuntimeReminder {
        id: leti_core::types::part::PartId(Uuid::nil()),
        reminder_kind: leti_core::types::part::ReminderKind::WorkspaceDelta,
    ...
    match dto {
        PartDto::RuntimeReminder {
            ...
            assert_eq!(
                reminder_kind,
                leti_core::types::part::ReminderKind::WorkspaceDelta
            );
