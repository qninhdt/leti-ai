...
use openlet_adapters::openrouter::{OpenRouterConfig, OpenRouterProvider, ProviderRouting};
use openlet_core::adapters::model_provider::{ChatRequest, ModelProvider};
...
async fn enrichment_lands_on_the_wire() {
    ...
    let config = OpenRouterConfig {
        referer: Some("https://openlet.ai".into()),
        title: Some("Openlet".into()),
    ...
    assert_eq!(header("http-referer"), Some("https://openlet.ai"));
    assert_eq!(header("x-title"), Some("Openlet"));
