...
use openlet_core::tools::builtins::web_fetch::{
...
const USER_AGENT: &str = concat!("openlet-web-fetch/", env!("CARGO_PKG_VERSION"));
...
mod tests {
    ...
    use openlet_core::tools::builtins::web_fetch::FetchFormat;
