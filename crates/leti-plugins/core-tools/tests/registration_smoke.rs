...
use leti_core::error::{MemoryError, ToolError};
use leti_core::runtime::subagent::TaskRegistry;
use leti_core::runtime::subagent::task_types::{SpawnError, TaskId, TaskStatus};
...
use leti_plugin_api::Plugin;
use leti_plugin_api::context::{CoreApi, PluginContext};
use leti_plugin_api::hooks::io::NotificationLevel;
use leti_plugin_core_tools::CoreToolsPlugin;
...
#[async_trait]
impl leti_core::tools::builtins::web_fetch::WebFetcher for StubFetcher {
    async fn fetch(
        &self,
        _req: leti_core::tools::builtins::web_fetch::FetchRequest,
    ) -> Result<
        leti_core::tools::builtins::web_fetch::FetchedPage,
        leti_core::tools::builtins::web_fetch::FetchError,
    > {
        Err(leti_core::tools::builtins::web_fetch::FetchError::Network(
