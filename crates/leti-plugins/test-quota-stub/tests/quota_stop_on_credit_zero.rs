...
use leti_plugin_api::dispatch::{DispatchOutcome, dispatch};
use leti_plugin_api::hooks::io::{BeforeTurnCtx, OnCostTickCtx};
...
impl RecordingCore {
    fn new(user_id: &str) -> Arc<Self> {
        ...
        let meta = SessionMeta {
            ...
            permission_mode: leti_core::types::permission::PermissionMode::default(),
...
) -> leti_plugin_api::context::PluginRegistrations {
