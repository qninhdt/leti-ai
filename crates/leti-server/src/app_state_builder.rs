...
impl AppStateBuilder {
    ...
    #[must_use]
    pub fn default_interaction_mode(
        mut self,
        v: leti_core::types::session::InteractionMode,
    ) -> Self {
        self.default_interaction_mode = v;
        self
    }
    ...
    pub fn build(self) -> Result<AppState, AppStateBuilderError> {
        ...
        let hook_chains = self
            .hook_chains
            .unwrap_or_else(|| Arc::new(leti_plugin_api::dispatch::HookChains::new()));
