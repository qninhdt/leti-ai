...
use leti_core::runtime::question_registry::{QuestionId, ResolveError};
use leti_protocol::QuestionAnswerDto;
use uuid::Uuid;
...
pub async fn answer(
    ...
    let session = leti_core::types::session::SessionId::from(session_id);
    state
        .questions
