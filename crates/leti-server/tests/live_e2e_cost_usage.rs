...
//! only when `LETI_LIVE_E2E=1` AND `OPENAI_API_KEY` are set; otherwise
...
//!     LETI_LIVE_E2E_MODEL=google/gemini-3.5-flash \
//!     cargo test -p leti-server --test live_e2e_cost_usage -- --nocapture
//!
