...
use leti_core::agent::{AgentDefinition, AgentRegistry, AgentSlug};
use leti_core::runtime::subagent::TaskRegistry;
use leti_core::tools::Tool;
use leti_core::tools::builtins::send_message::{SendMessageInput, SendMessageTool};
...
fn make_handle(root: SessionId) -> leti_core::runtime::subagent::TaskHandle {
    use std::sync::atomic::AtomicBool;
    use tokio::sync::{Notify, RwLock};
    use tokio_util::sync::CancellationToken;
    leti_core::runtime::subagent::TaskHandle {
        status: Arc::new(RwLock::new(
            leti_core::runtime::subagent::TaskStatus::Running,
        )),
...
fn session_meta(id: SessionId, parent: Option<SessionId>, slug: &str) -> SessionMeta {
    ...
    SessionMeta {
        id,
        agent_id: leti_core::types::agent::AgentId::new(),
