...
use leti_core::dispatch::{DispatchOutcome, FaultKind, HookChains, HookEntry, dispatch};
use leti_core::hooks::io::BeforeToolCallCtx;
use leti_core::hooks::{HookKind, HookResult, Priority};

fn entry_with(
    manifest_id: &str,
    priority: u8,
    registration_index: usize,
    func: impl Fn(BeforeToolCallCtx) -> leti_core::dispatch::HookFuture<BeforeToolCallCtx>
    + Send
    + Sync
    + 'static,
