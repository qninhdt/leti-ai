...
//!
//! Caps verified at:
//! - `crates/leti-core/src/runtime/attachments/image_resize.rs:29,33,39`
//!   - `MAX_DECODED_BYTES = 200 MiB`
//!   - `MAX_EDGE = 2000`
//!   - `MAX_OUTPUT_BYTES = 5 MiB`
//! - `crates/leti-core/src/runtime/attachments/pdf_text.rs:30`
...
use leti_core::runtime::attachments::image_resize::{ImageProcessError, process_image_blocking};
use leti_core::runtime::attachments::pdf_text::{MAX_INLINE_TEXT_CHARS, truncate_inline_text};
