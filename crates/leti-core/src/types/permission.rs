...
use super::session::InteractionMode;
...
pub struct PermissionCtx {
    ...
    /// Session-level foreground/detached policy. Permission managers may use
    /// it to avoid returning a human-waiting Pending decision in detached
    /// turns; the engine does not infer identity or authorization from it.
    #[serde(default)]
    pub interaction_mode: InteractionMode,
    /// Opaque host data carried for this turn; never serialized.
    #[serde(skip)]
