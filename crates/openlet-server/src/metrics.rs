...
//!
//! openlet-ai is *software*, not an infra bundle: metric emission via the
...
//! when `OPENLET_METRICS_BIND` is set. Running `./openlet-ai` locally needs
...
pub const METRICS_BIND_ENV: &str = "OPENLET_METRICS_BIND";
